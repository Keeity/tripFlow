...
exports.updateAttractionSchema = yup.object().shape({
    ...
    latitude: yup
        ...
        .test('is-valid-latitude', 'Latitude inválida, deve estar entre -90 e 90 e ter pelo menos 2 dígitos após o ponto decimal', (value) => {
            if (value === undefined) {
                return true;
            } const decimalPart = ('' + value).split('.')[1]; return value >= -90 && value <= 90 && decimalPart && decimalPart.length >= 2;
        }),
    longitude: yup
        .number('Insira apenas números')
        .test('is-valid-latitude', 'Longitude inválida, deve estar entre -90 e 90 e ter pelo menos 2 dígitos após o ponto decimal', (value) => { if (value === undefined) { return true; } const decimalPart = ('' + value).split('.')[1]; return value >= -90 && value <= 90 && decimalPart && decimalPart.length >= 2; }),
